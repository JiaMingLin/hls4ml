...
class VitisAcceleratorBackend(VitisBackend):
    ...
    def _register_flows(self):
        ...
        self._writer_flow = register_flow('write', writer_passes, requires=[vitis_ip], backend=self.name)
        self._default_flow = vitis_ip

        fifo_depth_opt_passes = ['vitisaccelerator:fifo_depth_optimization'] + writer_passes

        register_flow('fifo_depth_optimization', fifo_depth_opt_passes, requires=[vitis_ip], backend=self.name)
